...
export default function Page() {
  ...
  function downloadDemo() {
    ...
    for (let i = 0; dataStart + i * 2 + 2 <= dataEnd; i++) { const t = i / sampleRate; const envelope = Math.max(0, 1 - t * 2.2); view.setInt16(dataStart + i * 2, Math.sin(t * Math.PI * 2 * 92) * envelope * 22000, true) }
